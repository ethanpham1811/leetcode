...
const mdnLnk = `https://developer.mozilla.org/en-US/` + `docs/Web/API/Document/createDocumentFragment`
...
// ------------------------
const virtual = Object.assign(document.createElement(`p`), {
  innerHTML: `       
        <a href="#id1">id1</a>
        <div id="id2">Hi!</div>
        <p id="id3">Hi 2!</p>`,
...
const prepareHtml4Reporting = (html) => html.replace(/</g, `&lt;`).replace(/\n\s+/g, `\n`).replace(/\n\n/g, `\n`)
